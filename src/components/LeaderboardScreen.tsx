...
export const LeaderboardScreen: React.FC<LeaderboardScreenProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-[#f0dec1] text-[#4a2c17] font-serif selection:bg-[#f0c242] selection:text-stone-950 overflow-hidden relative">
      {/* Main Content Area */}
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-[#f0dec1] to-transparent pointer-events-none" />
    </div>
  );
};
